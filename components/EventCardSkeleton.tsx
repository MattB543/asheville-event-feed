export default function EventCardSkeleton() {
  return (
    <div className="bg-white border-b border-gray-200 flex flex-col sm:flex-row gap-4 p-4 animate-pulse">
      {/* Image Placeholder */}
      <div className="w-full sm:w-48 h-32 flex-shrink-0 bg-gray-200 rounded" />
