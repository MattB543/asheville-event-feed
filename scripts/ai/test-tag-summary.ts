 ...
 *
 * Usage: npx tsx scripts/ai/test-tag-summary.ts
 */
  ...
  const testEvents = [
    {
      ...
      description:
        'Grammy-winning bluegrass artist Billy Strings brings his incredible guitar skills and high-energy performances to Asheville for a special two-night run. Known for his virtuosic flatpicking and genre-bending style that incorporates elements of rock, metal, and jam band music into traditional bluegrass.',
    ...
    },
    {
      ...
      description:
        'Test your knowledge at our weekly trivia night! Teams of up to 6 players compete for prizes. Free to play, food and drink specials available.',
    ...
    },
    {
      ...
      description:
        'A unique yoga experience combining slow, heavy doom metal music with restorative yoga poses. No experience necessary. Bring your own mat.',
