...
export async function POST(request: NextRequest) {
  try {
    ...
    const displayName = isString(parsed.displayName) ? parsed.displayName : undefined;
    const title = isString(parsed.title) ? parsed.title : parsed.title === null ? null : undefined;
