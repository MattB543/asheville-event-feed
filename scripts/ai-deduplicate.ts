 ...
 *
 * Usage:
 *   npx tsx scripts/ai-deduplicate.ts           # Dry run (default)
 *   npx tsx scripts/ai-deduplicate.ts --apply   # Actually delete duplicates
 *   npx tsx scripts/ai-deduplicate.ts --days 7  # Only process next 7 days
 *
...
async function main() {
  ...
  if (applyChanges) {
    ...
    console.log("  npx tsx scripts/ai-deduplicate.ts --apply");
  }
}
