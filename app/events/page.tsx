...
const getHomeEvents = unstable_cache(
  async (): Promise<DbEvent[]> => {
    if (!process.env.DATABASE_URL) {
      console.warn("[Events] DATABASE_URL is not defined. Showing empty feed.");
      return [];
    }
    ...
    console.log(`[Events] Fetched ${allEvents.length} events, ${filteredEvents.length} after spam filter.`);
