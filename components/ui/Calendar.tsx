  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous:
          "pointer-events-auto h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 inline-flex items-center justify-center rounded-md border border-gray-200 hover:bg-gray-100 transition-colors cursor-pointer",
        button_next:
          "pointer-events-auto h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 inline-flex items-center justify-center rounded-md border border-gray-200 hover:bg-gray-100 transition-colors cursor-pointer",
        ...
        day_button:
          "h-9 w-9 p-0 font-normal inline-flex items-center justify-center rounded-md hover:bg-gray-100 transition-colors cursor-pointer",
        ...
        range_middle: "rounded-none bg-brand-50",
        hidden: "invisible",
        ...classNames,
      }}
      components={{
