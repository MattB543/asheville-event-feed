...
const EMAIL_SUBJECT = 'Switchyards Vibe Match is Saturday';
...
const TEMPLATE_PATH = path.join(process.cwd(), 'claude', 'email-copy-vibe-tomorrow.md');
...
export async function buildVibeTomorrowEmail(options: {
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #0f766e 0%, #0e7490 100%); padding: 32px 24px; text-align: center;">
              <h1 style="color: #ffffff; font-size: 24px; font-weight: 700; margin: 0;">
                Switchyards Vibe Match is Saturday
              </h1>
            </td>
          </tr>
          <tr>
