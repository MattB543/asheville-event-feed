              ...
              <section className="bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-800 p-6">
                ...
                <div className="space-y-3">
                  {tasteData.positive.map(item => {
                    ...
                    const slug = generateEventSlug(item.event.title, new Date(item.event.startDate), item.event.id);
                  ...
                  {tasteData.negative.map(item => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          onClick={() => handleRemoveSignal(item.event.id, "hide")}
                          disabled={isRemoving}
                          className="p-2 text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition-colors disabled:opacity-50"
                          title="Unhide event"
                        >
                    ...
                    {tasteData.inactive.map(item => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <button
                            onClick={() => handleReactivate(item.event.id)}
