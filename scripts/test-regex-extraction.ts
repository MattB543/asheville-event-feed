 ...
 *
 * Usage: npx tsx scripts/test-regex-extraction.ts
 */
...
import { extractPriceFromText, isTicketedEvent, isTypicallyTicketedVenue } from '../lib/utils/extractPrice';
import { extractTimeFromText } from '../lib/utils/extractTime';
