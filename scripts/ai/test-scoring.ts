  ...
  const testEvents = [
    {
      event: {
        ...
        description:
          'Living legend Bob Dylan performs in Asheville as part of his Rough And Rowdy Ways world tour. Phone-free show - all phones will be locked in Yondr pouches.',
        location: 'Harrahs Cherokee Center',
        organizer: 'Live Nation',
        tags: ['Live Music', 'Nightlife'],
        aiSummary:
          'Legendary musician Bob Dylan performs at Harrahs Cherokee Center as part of his Rough And Rowdy Ways Tour, featuring a phone-free concert experience.',
      ...
      similarEvents: [
        {
          ...
          location: 'Archetype Brewing',
          organizer: 'Archetype Brewing',
          startDate: new Date('2025-01-07T19:00:00'),
          similarity: 0.85,
        },
        {
          title: 'Wednesday Trivia',
          location: 'Highland Brewing',
          organizer: 'Highland Brewing',
          startDate: new Date('2025-01-08T18:30:00'),
          similarity: 0.82,
        },
        {
          title: 'Pub Quiz Night',
          location: 'Wicked Weed',
          organizer: 'Wicked Weed',
          startDate: new Date('2025-01-09T19:00:00'),
          similarity: 0.78,
        },
      ],
    },
    {
      event: {
        ...
        description:
          'A unique yoga experience combining slow, heavy doom metal music with restorative yoga poses.',
        location: 'The Mothlight',
        organizer: 'Asheville Weird Wellness',
        tags: ['Fitness', 'Live Music', 'Wellness'],
        aiSummary:
          'Unique yoga class at The Mothlight combining restorative poses with doom metal music for a meditative yet heavy experience.',
